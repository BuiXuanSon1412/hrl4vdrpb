...
SOLOMON_ROOT = "benchmark/vrptw-homberger-200"
# Directory to save the new VRPBTW datasets (before subfolders)
VRPBTW_ROOT = "benchmark/vrpbtw-homberger-200-derived"
...
def create_vrpbtw_instance_csv(
    ...
    new_filename = (
        f"{distribution_identifier}-n{target_size}-b{num_backhaul}-v{max_vehicles}.csv"
    )
