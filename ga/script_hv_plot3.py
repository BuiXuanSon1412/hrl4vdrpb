...
COLORS = ["#3D5E95", "#458855", "#A94145", "#B85E1C"]
...
def plot_combined_distribution_boxplot():
    ...
    ax.set_xticklabels(DISTRIBUTIONS, fontsize=12, fontweight="bold")
    ...
    plt.tight_layout()
    save_path = output_dir / f"{ALGORITHM}_HV_grouped_boxplot.png"
